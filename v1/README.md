# o_x — PS4 Exploit Host

> A modern, terminal-styled web-based exploit host for the PlayStation 4 (FW 6.00–11.02).

![Terminal UI](includes/ps.gif)

---

## Overview

**o_x** is a self-hosted, browser-based jailbreak tool for the PlayStation 4. It leverages a WebKit/JavaScript exploit chain running entirely from the PS4's built-in web browser — no PC or external dongle required after the initial setup.
...
**Project:** o_x PS4 Exploit Host  
**Owner:** o_x  
**Location:** My private office
